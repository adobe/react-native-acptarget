        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            switch (type) {
                ...
                case String:
                    ...
                    break;
                case Map:
                    array[i] = RCTACPTargetMapUtil.toMap(readableArray.getMap(i));
                    break;
                case Array:
                    array[i] = RCTACPTargetArrayUtil.toObjectArray(readableArray.getArray(i));
                    break;
            }
        }
    ...
    public static WritableArray toWritableArray(Object[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (value == null) {
                ...
                writableArr.pushMap(RCTACPTargetMapUtil.toWritableMap((Map<String, Object>) value));
            } else if (value.getClass().isArray()) {
                writableArr.pushArray(RCTACPTargetArrayUtil.toWritableArray((Object[]) value));
            }
        }
